...
type Interface interface {
	...
	DeviceGetConfComputeGpuAttestationReport(Device, []byte) (ConfComputeGpuAttestationReport, Return)
...
type Device interface {
	...
	GetConfComputeGpuAttestationReport([]byte) (ConfComputeGpuAttestationReport, Return)
